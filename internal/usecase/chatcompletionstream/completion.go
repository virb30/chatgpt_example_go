...
import (
	...
	"github.com/virb30/chatservice/internal/domain/entity"
	"github.com/virb30/chatservice/internal/domain/gateway"
)
...
func (uc *ChatCompletionUseCase) Execute(ctx context.Context, input ChatCompletionInputDTO) (*ChatCompletionOutputDTO, error) {
	...
	if err != nil {
		return nil, errors.New("error creating chat commpletion: " + err.Error())
	}
